  ...
  <div class="edit_container">
    ...
    <el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
      ...
      <el-form-item label="视频" prop="url">
        ...
        <!--<div slot="tip" class="el-upload__tip">只能上传jpg/png文件</div>-->
        <!--</el-upload>-->
        <el-upload class="avatar-uploader el-upload--text" action="portal/uploadVideo" :show-file-list="false" :on-success="handleUploadVideoSuccess">
          <video v-if="addForm.url !='' && videoFlag == false" :src="addForm.url" class="avatar" controls="controls">您的浏览器不支持视频播放</video>
          <i v-else-if="addForm.url =='' && videoFlag == false" class="el-icon-plus avatar-uploader-icon"></i>
